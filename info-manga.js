/**
 * INFO-MANGA.JS - LCP OPTIMIZED with Giscus Support
 */
...
async function loadMangaFromRepo() {
    try {
        ...
        // Emit event for Giscus to load
        window.dispatchEvent(new Event('mangaDataLoaded'));
...
/**
 * Fetch MangaDex rating with cache
 */
async function fetchMangaDexRating() {
    try {
        ...
        const gasUrl = `https://script.google.com/macros/s/AKfycbwZ0-VeyloQxjvh-h65G0wtfAzxVq6VYzU5Bz9n1Rl0T4GAkGu9X7HmGh_3_0cJhCS1iA/exec?action=getRating&mangaId=${mangaId}`;
